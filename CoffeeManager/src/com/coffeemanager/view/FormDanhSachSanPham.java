 ...
 * @author Yuu
 */
public class FormDanhSachSanPham extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormDanhSachSanPham.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
